...
- [ ] **1. LimitlessKit ядро** — модели, `LimitlessClient`, ошибки, пагинация. ← начинаем здесь
- [ ] **2. Хранилище** — протокол `LifelogStore` + GRDB-реализация, миграции.
- [ ] **3. SyncManager** — инкрементальная дельта-синхра + тесты.
- [ ] **4. iOS UI (SwiftUI)** — список, деталь с таймлайном спикеров, экран настроек (ввод ключа).
- [ ] **5. Keychain** — безопасное хранение ключа.
- [ ] **6. Spring Boot приёмник** — endpoint + JPA-сущность + outbox-отправка с клиента.
